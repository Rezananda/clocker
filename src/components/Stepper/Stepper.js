  ...
  return (
    <div className='flex items-center mb-4'>
        <div className='flex flex-col justify-center items-center'>
          <div className={`relative flex items-center justify-center rounded-full h-8 w-8 ${stepAddGroup === 1 || stepAddGroup === 2 || stepAddGroup === 3 ? 'bg-blue-100' : 'bg-gray-300 dark:bg-slate-800'} `}>
        ...
        <div className='flex flex-col justify-center items-center'>
          <div className={`relative flex items-center justify-center rounded-full h-8 w-8 ${stepAddGroup === 2 || stepAddGroup === 3 ? ' bg-blue-100 ' : 'bg-gray-300 dark:bg-slate-800'} `}>
        ...
        <div className='flex flex-col justify-center items-center'>
          <div className={`relative flex items-center justify-center rounded-full h-8 w-8 ${stepAddGroup === 3 ? ' bg-blue-100 ' : 'bg-gray-300 dark:bg-slate-800'} `}>
