...
const Navbar = () => {
  ...
  return (
            <ul className="w-full grid grid-cols-3 gap-4 py-2 h-18 fixed bottom-0 bg-white rounded-t-xl border-t border-gray-200 md:w-1/4 dark:bg-slate-800 dark:border-gray-600">
