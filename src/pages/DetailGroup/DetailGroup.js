  ...
  return (
    ...
    {initilaizingGroupInfo? <LoadingDetailGroup/> : 
        <div>
            ...
            : tab === 2 ? 
            <GroupAttendance initializeGetAllAttendance={initializeGetAllAttendance} allAttendance={allAttendance} attendanceEmpty={attendanceEmpty} scroll={scroll} filter={filter} groupInfo={groupInfo} initilaizingGroupInfo={initilaizingGroupInfo}/>
            :
            null
            }
        </div>
