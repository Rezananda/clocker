  ...
  return (
    ...
    <div className='flex flex-col gap-4'>
      <div className='flex flex-col items-center justify-center gap-1'>
        ...
        <p className='text-lg font-bold text-center dark:text-white'>BERHASIL</p>
      </div>
        <ul className='flex flex-col gap-2 text-center bg-blue-50 rounded-xl py-2'>
          ...
          {attendanceData.startDate&&attendanceData.endDate&&<li><p>Lama Cuti</p> <p className='font-bold text-lg'>{new Date(attendanceData.startDate).toLocaleDateString()} - {new Date(attendanceData.endDate).toLocaleDateString()}</p></li>}
