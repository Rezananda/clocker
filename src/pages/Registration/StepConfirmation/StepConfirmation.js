...
const StepConfirmation = () => {
  ...
  return (
      <div className='h-screen flex justify-center items-center px-4'>
        <div className='p-4 bg-white items-center rounded-xl drop-shadow'>
            ...
            <p className="text-center mb-4">Lakukan aktivasi pada link yang dikirim pada emailmu.</p>
            <div className='border-t border-gray-150 mb-4'></div>
            <div className='w-full'>
                <ButtonOutline label={'OK'} handleClick={() => navigate('/login')}/>
            </div>
        </div>
      </div>
  )
