...
const InputGroupCode = ({setGroupCode, groupCode, handleCheckCodeGroup, initializingGroupCodeData, groupCodeData}) => {
  const validateForm = () => {
  ...
  return (
    <div className='flex flex-col gap-4'>
      <div>
        ...
        <Input maxLength={20} handleChange={(e) => setGroupCode(e.target.value)} type="text" name="groupCode" placeholder="Input Kode Group"/>
      ...
      <ButtonFill label="Lanjut" handleClick={handleCheckCodeGroup} disabled={validateForm()} additionalClass={validateForm() ? 'bg-blue-200 border-blue-200' : ""}/>
