  ...
  return (
    <div className='flex flex-col gap-4'>
        <div className='flex flex-col items-center justify-center gap-1'>
          ...
          <p className='text-lg font-bold text-center'>MENUNGGU PERSETUJUAN ADMIN</p>
        </div>
        <ul className='flex flex-col gap-2 text-center bg-blue-50 rounded-xl py-2'>
            <li><p className='text-sm'>Nama Grup</p><p className='font-bold text-lg'>{groupCodeData.groupName}</p></li>
            <li><p className='text-sm'>Pemilik Grup</p><span className='font-bold text-lg'>{groupCodeData.groupOwnerName}</span></li>
        </ul>
