  ...
  return (
    <>
      <div className='flex flex-col sticky top-0'>
        <TopNavbar navbarColor={`bg-blue-500`} label={'Kehadiran Saya'} back={true} labelColor={`text-white`} navigateTo={-1}/>
      </div>
      ...
      <div>
        ...
        <div className='flex w-full gap-1 overflow-x-auto scrollable mb-2 mt-4 px-4'>
        ...
        <div className='flex flex-col overflow-y-auto h-screen px-4' id="scrollableDiv">
          ...
          <ul>
            {personalAttendance !== 'noAttendance'&&<InfiniteScroll
                ...
                {personalAttendance !== "noAttendance" && personalAttendance.map((val, index) => (
                  <li key={index} className='bg-white px-4 py-2 flex justify-between border-b border-gray-200 dark:bg-slate-800 dark:border-gray-600 dark:text-white'>
